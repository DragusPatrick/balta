...
<div id="modal-form" class="popup-basic admin-form theme-primary mfp-with-anim">
	<div class="panel">
		<div class="panel-heading">
			<span class="panel-title"><i class="fa fa-edit"></i>Sterge Client</span>
		</div>
		<?php if(isset($id)) : ?>
			
			<form method="post" action="users/remove_user/<?php echo $id; ?>" data-form-dt="users-list">
				
				<div class="panel-body ">
					<div class="alert alert-danger alert-micro hidden"></div>
						<p style="font-size: 20px;text-align: center;color: red;margin-bottom: 40px;"> Confirmare stergere client </p>
